...
public class EternalFeatherInfo extends StatsInfo {

    private static int healing;
    private static String statId = getLocId(EternalFeather.ID);
    ...
    @SpirePrefixPatch
    public static void prefix(EternalFeather _instance, AbstractRoom room) {
        startingHp = AbstractDungeon.player.currentHealth;
    }

    @SpirePostfixPatch
    public static void postfix(EternalFeather _instance, AbstractRoom room) {
