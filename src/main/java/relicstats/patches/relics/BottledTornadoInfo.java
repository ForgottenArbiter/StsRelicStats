...
public class BottledTornadoInfo extends StatsInfo {

    private static String card;
    private static String savedText;
    private static String statId = getLocId(BottledTornado.ID);
    ...
    public static void insert(BottledTornado _instance) {
    ...
    private static class Locator extends SpireInsertLocator {
        public int[] Locate(CtBehavior ctMethodToPatch) throws CannotCompileException, PatchingException {
            Matcher matcher = new Matcher.FieldAccessMatcher(BottledTornado.class, "tips");
