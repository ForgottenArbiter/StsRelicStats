...
public class BottledLightningInfo extends StatsInfo {

    private static String card;
    private static String savedText;
    private static String statId = getLocId(BottledLightning.ID);
    ...
    public static void insert(BottledLightning _instance) {
    ...
    private static class Locator extends SpireInsertLocator {
        public int[] Locate(CtBehavior ctMethodToPatch) throws CannotCompileException, PatchingException {
            Matcher matcher = new Matcher.FieldAccessMatcher(BottledLightning.class, "tips");
